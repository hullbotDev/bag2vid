...
namespace bag2vid
{
    ...
    public:
        ...
        void setBagStartTime(double time)
        {
            start_bag_time_ = time;
            duration_ = end_bag_time_ - start_bag_time_;
            update();
        }
        void setBagEndTime(double time)
        {
            end_bag_time_ = time;
            duration_ = end_bag_time_ - start_bag_time_;
            update();
    ...
    private:
        double start_bag_time_ = 0.0;
        double end_bag_time_ = 1.0;
